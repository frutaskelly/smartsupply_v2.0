...
const config: CrudConfig<EsquemaImpuesto> = {
  ...
  columns: [
    ...
    { header: "IEPS", cell: (e) => `${(Number(e.ieps_tasa) * 100).toFixed(2)}%`, className: "text-right" },
  ...
  fields: [
    ...
    { name: "iva_tasa", label: "Tasa IVA", type: "decimal", hint: "fracción: 0.16 = 16%" },
    { name: "ieps_tasa", label: "Tasa IEPS", type: "decimal", hint: "fracción: 0.08 = 8%" },
    { name: "retencion_iva_tasa", label: "Retención IVA", type: "decimal" },
    { name: "retencion_isr_tasa", label: "Retención ISR", type: "decimal" },
